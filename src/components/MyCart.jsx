...
console.log(MyCartData)
    useEffect(()=>{
        fetch(`https://technology-and-electronics-server-gamma.vercel.app/cartData/${email}`)
        .then(res => res.json())
    ...
    const handleDelete = (_id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://technology-and-electronics-server-gamma.vercel.app/cartData/${_id}`,
                {method: "DELETE"}
                )
                .then(res => res.json())
                .then(data => {console.log(data)
